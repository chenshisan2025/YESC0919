import{c as u,n as w,i as O,r as d,a as N,x as n,o as Q,U as be,b as ye}from"./index-DJD1rnIF.js";import{i as xe,p as Ce,s as ke,j as Se,M as v,S as de,R as l,k as _,l as B,m as D,x as f,A as X,n as we,o as ue,C as m,q as F,u as We,v as k,E as ne,O as I,y as Z,z as se,B as A,D as V,T as $e,F as Re,G as Ae,I as Te}from"./core-BJX90Pjj.js";import"./index-DUY-5k9x.js";import"./index.es-Gz-siRdk.js";const p=Ce({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Oe={state:p,subscribe(s){return Se(p,()=>s(p))},subscribeKey(s,e){return ke(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},T=xe(Oe),pe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){v.shake();return}if(await de.isSIWXCloseDisabled()){v.shake();return}v.close()}},Ne=_`
  :host {
    display: block;
