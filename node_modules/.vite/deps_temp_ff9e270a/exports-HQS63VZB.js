import {
  ...
  Lf,
  Yi
} from "./chunk-ODAQ7CQM.js";
import "./chunk-UC5DV5YL.js";
import "./chunk-QC77SLQG.js";
import {
  AccountController,
  ChainController,
  ...
  customElement,
  subscribeKey
} from "./chunk-MVMLPTYB.js";
import "./chunk-GN5BLL5Z.js";
import "./chunk-2MB3F5WC.js";
import "./chunk-DGSR6ZJQ.js";
import {
  proxy,
  ref,
  subscribe
...
var SIWEController = {
  ...
  async signOut() {
    ...
    (_a3 = client.onSignOut) == null ? void 0 : _a3.call(client);
  },
  onSignIn(args) {
    var _a3;
    const client = this._getClient();
    (_a3 = client.onSignIn) == null ? void 0 : _a3.call(client, args);
  },
  onSignOut() {
    var _a3;
    const client = this._getClient();
...
var Web3ModalSIWEClient = class {
  ...
  async getMessageParams() {
    var _a3, _b2;
    return await ((_b2 = (_a3 = this.methods).getMessageParams) == null ? void 0 : _b2.call(_a3)) || {};
  }
  createMessage(args) {
  ...
  async signIn() {
    ...
    const signOutOnNetworkChange = (_a3 = SIWEController.state._client) == null ? void 0 : _a3.options.signOutOnNetworkChange;
  ...
  async signOut() {
    var _a3, _b2;
    (_b2 = (_a3 = this.methods).onSignOut) == null ? void 0 : _b2.call(_a3);
...
function getAddressFromMessage(message) {
  var _a3;
  return ((_a3 = message.match(ETH_ADDRESS_PATTERN)) == null ? void 0 : _a3[0]) || "";
}
function getChainIdFromMessage(message) {
  var _a3;
  return `eip155:${((_a3 = message.match(ETH_CHAIN_ID_IN_SIWE_PATTERN)) == null ? void 0 : _a3[1]) || 1}`;
}
...
var W3mConnectingSiweView = class W3mConnectingSiweView2 extends LitElement {
  ...
  async onSign() {
    ...
    EventsController.sendEvent({
      ...
      type: "track",
      properties: {
        network: ((_a3 = NetworkController.state.caipNetwork) == null ? void 0 : _a3.id) || "",
...
@lit/reactive-element/development/decorators/query-assigned-nodes.js:
   ...
   *)
*/
//# sourceMappingURL=exports-HQS63VZB.js.map
