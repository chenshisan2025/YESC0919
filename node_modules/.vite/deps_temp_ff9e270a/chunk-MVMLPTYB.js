import {
  ...
  E,
  k
} from "./chunk-GN5BLL5Z.js";
import {
  require_buffer
} from "./chunk-2MB3F5WC.js";
import {
  require_browser
} from "./chunk-DGSR6ZJQ.js";
import {
  proxy,
  ref,
  snapshot,
...
function proxyMap(entries2) {
  const map = proxy({
    ...
    get(key) {
      var _a5;
      return (_a5 = this.data.find((p) => p[0] === key)) == null ? void 0 : _a5[1];
    },
    delete(key) {
  ...
  mergeMultiChainConnectors(connectors) {
    ...
    const refactoredConnectors = Array.from(connectorsByNameMap.values()).map((_connectors) => {
      ...
      if (_connectors.length > 1) {
        return {
          name: (_a5 = _connectors[0]) == null ? void 0 : _a5.name,
...
var ChainController = {
  ...
  subscribeChainProp(property2, callback) {
    ...
    return subscribe(state7.chains, () => {
      ...
      const activeChain = state7.activeChain;
      if (activeChain) {
        const nextValue = (_a5 = state7.chains.get(activeChain)) == null ? void 0 : _a5[property2];
        if (prev !== nextValue) {
          prev = nextValue;
          callback(nextValue);
        }
  ...
  setActiveChain(chain) {
    ...
    if (newAdapter && newAdapter.chain !== state7.activeChain) {
      ...
      state7.activeCaipNetwork = ((_a5 = newAdapter.networkState) == null ? void 0 : _a5.caipNetwork) ? ref((_b3 = newAdapter.networkState) == null ? void 0 : _b3.caipNetwork) : void 0;
  ...
  getAccountProp(key, _chain) {
    ...
    const chainAccountState = (_a5 = state7.chains.get(chain)) == null ? void 0 : _a5.accountState;
  ...
  getNetworkProp(key) {
    ...
    const chainNetworkState = (_a5 = state7.chains.get(chainToWrite)) == null ? void 0 : _a5.networkState;
...
var NetworkController = {
  ...
  setActiveCaipNetwork(caipNetwork) {
    ...
    if (!((_b3 = (_a5 = ChainController.state.chains.get(caipNetwork.chain)) == null ? void 0 : _a5.networkState) == null ? void 0 : _b3.allowUnsupportedChain)) {
  ...
  getRequestedCaipNetworks(chainToFilter) {
    ...
    chainAdapters.forEach((chn) => {
      var _a5, _b3, _c, _d, _e, _f, _g, _h;
      if ((_b3 = (_a5 = ChainController.state.chains.get(chn)) == null ? void 0 : _a5.networkState) == null ? void 0 : _b3.approvedCaipNetworkIds) {
  ...
  async switchActiveNetwork(network) {
    var _a5;
    const networkControllerClient = network ? (_a5 = ChainController.state.chains.get(network.chain)) == null ? void 0 : _a5.networkControllerClient : void 0;
  ...
  getApprovedCaipNetworkIds(chainToFilter) {
    ...
    if (chainToFilter) {
      ...
      return (_b3 = (_a5 = ChainController.state.chains.get(chain)) == null ? void 0 : _a5.networkState) == null ? void 0 : _b3.approvedCaipNetworkIds;
    }
    ...
    Object.values(ChainController.state.chains).forEach((adapter) => {
      ...
      if (adapter.networkState.approvedCaipNetworkIds) {
        allCaipNetworkIds.push(...((_a6 = adapter.networkState) == null ? void 0 : _a6.approvedCaipNetworkIds) || []);
      }
    });
  ...
  checkIfSupportedNetwork() {
    ...
    const activeCaipNetwork = (_b3 = (_a5 = ChainController.state.chains.get(chain)) == null ? void 0 : _a5.networkState) == null ? void 0 : _b3.caipNetwork;
  ...
  getSupportsAllNetworks() {
    ...
    return (_b3 = (_a5 = ChainController.state.chains.get(chain)) == null ? void 0 : _a5.networkState) == null ? void 0 : _b3.supportsAllNetworks;
  },
  ...
  getActiveNetworkTokenAddress() {
    var _a5, _b3;
    const address = ConstantsUtil2.NATIVE_TOKEN_ADDRESS[((_a5 = this.state.caipNetwork) == null ? void 0 : _a5.chain) || "evm"];
  ...
  constructor(projectId, isAppClient = false, chainId = "eip155:1") {
    ...
    this.events = {
      registerFrameEventHandler: (id, callback, signal) => {
        function eventHandler({ data }) {
          var _a5;
          if (!((_a5 = data.type) == null ? void 0 : _a5.includes(W3mFrameConstants.FRAME_EVENT_KEY))) {
            return;
          }
      ...
      onAppEvent: (callback) => {
        if (W3mFrameHelpers.isClient) {
          window.addEventListener("message", ({ data }) => {
            var _a5;
            if (!((_a5 = data.type) == null ? void 0 : _a5.includes(W3mFrameConstants.APP_EVENT_KEY))) {
              return;
            }
      ...
      postAppEvent: (event) => {
        var _a5;
        if (W3mFrameHelpers.isClient) {
          if (!((_a5 = this.iframe) == null ? void 0 : _a5.contentWindow)) {
    ...
    if (isAppClient) {
      ...
      if (W3mFrameHelpers.isClient) {
        ...
        this.iframe.onload = () => {
          var _a5;
          (_a5 = this.frameLoadPromiseResolver) == null ? void 0 : _a5.resolve(void 0);
        };
        this.iframe.onerror = () => {
          var _a5;
          (_a5 = this.frameLoadPromiseResolver) == null ? void 0 : _a5.reject("Unable to load email login dependency");
        };
      }
    }
  }
...
var W3mFrameLogger = class {
  constructor(projectId) {
    ...
    if (typeof window !== "undefined" && ((_a5 = this.chunkLoggerController) == null ? void 0 : _a5.downloadLogsBlobInBrowser)) {
      if (!window.downloadAppKitLogsBlob) {
        window.downloadAppKitLogsBlob = {};
      }
      window.downloadAppKitLogsBlob["sdk"] = () => {
        var _a6;
        if ((_a6 = this.chunkLoggerController) == null ? void 0 : _a6.downloadLogsBlobInBrowser) {
...
var W3mFrameProvider = class {
  ...
  async request(req) {
    ...
    try {
      ...
      (_a5 = this.rpcRequestHandler) == null ? void 0 : _a5.call(this, req);
      const response = await this.appEvent({
  ...
  async appEvent(event) {
    ...
    return new Promise((resolve, reject) => {
      ...
      (_b3 = (_a5 = this.w3mLogger.logger).info) == null ? void 0 : _b3.call(_a5, { event, id }, "Sending app event");
      ...
      function handler(framEvent) {
        ...
        if (framEvent.type === `@w3m-frame/${type}_SUCCESS`) {
          ...
          if ("payload" in framEvent) {
            reject(new Error(((_a6 = framEvent.payload) == null ? void 0 : _a6.message) || "An error occurred"));
          }
...
var ConnectionController = {
  ...
  async connectExternal(options, chain) {
    var _a5, _b3;
    await ((_b3 = (_a5 = this._getClient(chain)).connectExternal) == null ? void 0 : _b3.call(_a5, options));
  ...
  checkInstalled(ids, chain) {
    var _a5, _b3;
    return ((_b3 = (_a5 = this._getClient(chain)).checkInstalled) == null ? void 0 : _b3.call(_a5, ids)) || false;
  },
  resetWcConnection() {
...
var SwapApiUtil = {
  async getTokenList() {
    ...
    const tokens = ((_a5 = response == null ? void 0 : response.tokens) == null ? void 0 : _a5.map((token) => ({
      ...token,
      eip2612: false,
      quantity: {
        decimals: "0",
...
var SwapController = {
  ...
  getParams() {
    ...
    const invalidToToken = !((_a5 = state16.toToken) == null ? void 0 : _a5.address) || !((_b3 = state16.toToken) == null ? void 0 : _b3.decimals);
  ...
  resetValues() {
    ...
    const networkToken = (_a5 = state16.tokens) == null ? void 0 : _a5.find((token) => token.address === networkAddress);
  ...
  async getInitialGasPrice() {
    ...
    switch ((_a5 = NetworkController.state.caipNetwork) == null ? void 0 : _a5.chain) {
      case "solana":
  ...
  async sendTransactionForSwap(data) {
    ...
    const snackbarPendingMessage = `Swapping ${(_a5 = state16.sourceToken) == null ? void 0 : _a5.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_b3 = state16.toToken) == null ? void 0 : _b3.symbol}`;
  ...
  async getQuote() {
    ...
    try {
      const quote = await BlockchainApiController.getOnrampQuote({
        ...
        amount: ((_a5 = state19.paymentAmount) == null ? void 0 : _a5.toString()) || "0",
...
var SendController = {
  ...
  sendToken() {
    var _a5;
    switch ((_a5 = ChainController.state.activeCaipNetwork) == null ? void 0 : _a5.chain) {
      case "evm":
        this.sendEvmToken();
        return;
      case "solana":
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MVMLPTYB.js.map
