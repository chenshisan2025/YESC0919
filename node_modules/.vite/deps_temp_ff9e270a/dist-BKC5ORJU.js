...
import {
  ...
  l,
  y
} from "./chunk-LPDK3LHP.js";
import "./chunk-6AZ6QN3P.js";
import {
  import_index
} from "./chunk-IB4GYR3G.js";
import "./chunk-VEFVQRSD.js";
import {
  createPublicClient,
  decodeEventLog,
  defineChain,
...
function toBytes3(hex2, options = {}) {
...
function ecdsa(Point2, hash8, ecdsaOpts = {}) {
  ...
  class Signature {
    ...
    static fromHex(hex2, format9) {
      return this.fromBytes(hexToBytes2(hex2), format9);
    }
...
function toBytes8(value) {
  ...
  for (let i2 = 0, j = 0; i2 < base642.length; i2 += 4, j += 3) {
...
function fromHex7(hex2, group) {
  return fromBytes7(toBytes3(hex2), group);
}
...
// node_modules/@base-org/account/node_modules/@scure/base/lib/esm/index.js
function isBytes4(a) {
  return a instanceof Uint8Array || ArrayBuffer.isView(a) && a.constructor.name === "Uint8Array";
}
...
var createBase58check = (sha2567) => chain(checksum3(4, (data) => sha2567(sha2567(data))), base58);
...
var hasHexBuiltin4 = (() => typeof Uint8Array.from([]).toHex === "function" && typeof Uint8Array.fromHex === "function")();
var hexBuiltin = {
  encode(data) {
    abytes4(data);
    return data.toHex();
...
var hex = hasHexBuiltin4 ? hexBuiltin : chain(radix2(4), alphabet("0123456789abcdef"), join(""), normalize2((s) => {
...
function ahash3(h2) {
  if (typeof h2 !== "function" || typeof h2.create !== "function")
    throw new Error("Hash should be wrapped by utils.createHasher");
  anumber5(h2.outputLen);
  anumber5(h2.blockLen);
}
...
function mnemonicToSeedSync(mnemonic, passphrase = "") {
  return pbkdf2(sha5124, normalize3(mnemonic).nfkd, psalt(passphrase), { c: 2048, dkLen: 64 });
}
...
var Signer = class {
  ...
  updateChain(chainId, newAvailableChains) {
    ...
    const chain2 = chains2 === null || chains2 === void 0 ? void 0 : chains2.find((chain3) => chain3.id === chainId);
    if (!chain2)
      return false;
    if (chain2 !== this.chain) {
      this.chain = chain2;
      store.account.set({
        chain: chain2
      });
      (_a = this.callback) === null || _a === void 0 ? void 0 : _a.call(this, "chainChanged", hexStringFromNumber(chain2.id));
    }
    return true;
  }
...
@noble/curves/esm/p256.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=dist-BKC5ORJU.js.map
