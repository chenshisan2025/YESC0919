...
var ICONS = {
  add: async () => (await import("./add-T4DO765L.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-ZSVR2WV6.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-WTDF36IE.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-WTLCDWZE.js")).appStoreSvg,
  apple: async () => (await import("./apple-XSHG7VBC.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-YV3FYMKC.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-HCMEDE64.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-OTDIBFM5.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-L57YJO25.js")).arrowTopSvg,
  bank: async () => (await import("./bank-JEUES6RX.js")).bankSvg,
  browser: async () => (await import("./browser-AQT7OTGQ.js")).browserSvg,
  card: async () => (await import("./card-DKLRITP5.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-A7CEM52G.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-7R54VL4T.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-FMVGYIMS.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-FLLBIKET.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-HTLNECRM.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-VF6E6N3F.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-PAJ3GJBG.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-6G7PFXS7.js")).clockSvg,
  close: async () => (await import("./close-GFQMRE2L.js")).closeSvg,
  compass: async () => (await import("./compass-ETKKFL25.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-UFSODVEO.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-UO5KKYRJ.js")).copySvg,
  cursor: async () => (await import("./cursor-R65SIBU6.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-HOUV2DZY.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-67ZF4KLV.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-RL6IPEQ3.js")).disconnectSvg,
  discord: async () => (await import("./discord-IFAJQWVP.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-2UFSEDY6.js")).etherscanSvg,
  extension: async () => (await import("./extension-R2VHIEOE.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-JCJOZ4BX.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-XJJHUCDG.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-5UERWDAP.js")).farcasterSvg,
  filters: async () => (await import("./filters-N3AIC3ND.js")).filtersSvg,
  github: async () => (await import("./github-LHAKL4KM.js")).githubSvg,
  google: async () => (await import("./google-2WKKWNVO.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-KL2TE3G7.js")).helpCircleSvg,
  image: async () => (await import("./image-QN5UN4WT.js")).imageSvg,
  id: async () => (await import("./id-R6YPDMIC.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-VFQLKSMW.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-RDMC2LFG.js")).lightbulbSvg,
  mail: async () => (await import("./mail-2CQ2BFHO.js")).mailSvg,
  mobile: async () => (await import("./mobile-CJPSXGRN.js")).mobileSvg,
  more: async () => (await import("./more-MHPTMMOF.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-DT6YV43Q.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-QUZZPRM2.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-ZGZMBXTR.js")).offSvg,
  playStore: async () => (await import("./play-store-XGPWTCLX.js")).playStoreSvg,
  plus: async () => (await import("./plus-7ONER6PZ.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-IREGZRNK.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-HDCNPOZR.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-ECNOYGX3.js")).refreshSvg,
  search: async () => (await import("./search-GVJEIMAG.js")).searchSvg,
  send: async () => (await import("./send-AUW3BZNP.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-NH6UCU2O.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-SIYQUS4R.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-653KNK5I.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-UACPMUHN.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-GQZ2XW3D.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-CNFNKFIT.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-GFLU4IDW.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-XPUVBS4L.js")).twitchSvg,
  twitter: async () => (await import("./x-GCZWXQBX.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-NLXGWNVS.js")).twitterIconSvg,
  verify: async () => (await import("./verify-MIPV2I56.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-4FE73NP4.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-7UVFUQOZ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-WFHY5CKH.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-WFHY5CKH.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-WFHY5CKH.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-ISCMOQRG.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-XYV6UY7O.js")).warningCircleSvg,
  x: async () => (await import("./x-GCZWXQBX.js")).xSvg,
  info: async () => (await import("./info-JYXOGWD2.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-N6NJZNHC.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-EG6HLCT7.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7LCYRGEY.js.map
