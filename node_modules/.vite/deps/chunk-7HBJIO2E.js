...
var WuiProfileButtonV2 = class WuiProfileButtonV22 extends LitElement {
  ...
  handleClick(event) {
    ...
    if (event.target instanceof HTMLElement && event.target.id === "copy-address") {
      (_a4 = this.onCopyClick) == null ? void 0 : _a4.call(this, event);
      return;
    }
...
var WuiListAccount = class WuiListAccount2 extends LitElement {
  ...
  connectedCallback() {
    var _a4;
    super.connectedCallback();
    BlockchainApiController.getBalance(this.accountAddress, (_a4 = this.caipNetwork) == null ? void 0 : _a4.id).then((response) => {
  ...
  getLabel() {
    var _a4;
    let label = (_a4 = this.labels) == null ? void 0 : _a4.get(this.accountAddress);
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7HBJIO2E.js.map
