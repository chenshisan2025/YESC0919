  ...
  async initControllers(options) {
    ...
    if (evmAdapter) {
      if (options.siweConfig) {
        const { SIWEController } = await import("./exports-TAL22L6Y.js");
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([import("./esm-R6BW5PGE.js"), import("./w3m-modal-D7WNY7J3.js")]);
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XNXXA5FN.js.map
